...
exp_name=${exp_name:-"DAPO-Filter-ne-${num_environment_per_step}-model-${model_name}-lr-${lr}-bsz-${train_prompt_bsz}-n_resp-${n_resp_per_prompt}-mini-${train_prompt_mini_bsz}-gpus-${num_gpus}"}
...
TRAIN_FILE=${TRAIN_FILE:-"/inspire/hdd/global_user/xucaijun-253108120121/Code/FORGE/train_configs_ema_nonzero_pruned.json"}
TEST_FILE=${TEST_FILE:-["/inspire/hdd/global_user/xucaijun-253108120121/Dataset-P/think_MATH-500_MATH-500-processed.parquet","/inspire/hdd/global_user/xucaijun-253108120121/Dataset-P/think_amc23_amc23_test.parquet","/inspire/hdd/global_user/xucaijun-253108120121/Dataset-P/think_aime24_aime24_test.parquet","/inspire/hdd/global_user/xucaijun-253108120121/Dataset-P/MMLU-Pro-Valid.parquet","/inspire/hdd/global_user/xucaijun-253108120121/Dataset-P/GPQA-Diamond-Test.parquet"]}
