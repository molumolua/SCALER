...
exp_name=${exp_name:-"20-windows-W-${enable_weighted_sample}-Instruction-ne-${num_environment_per_step}-model-${model_name}-lr-${lr}-bsz-${train_prompt_bsz}-n_resp-${n_resp_per_prompt}-mini-${train_prompt_mini_bsz}"}
...
TRAIN_FILE=${TRAIN_FILE:-"//inspire/hdd/global_user/xucaijun-253108120121/Code/FORGE_SECOND/FORGE_train_data_2917_windows_20.json"}
